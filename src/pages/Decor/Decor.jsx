...
const Decor = ({ localQuantities, setLocalQuantities }) => {
    ...
    const handleOrder = () => {
        ...
        if (decor.name !== "" && decor.phone !== "") {
            ...
            setDecorVisablet({ ...decorVisablet, nameVisablet: false });
            setDecorVisablet({ ...decorVisablet, phoneVisablet: false });
        } else if (decor.name === "") {
            setDecorVisablet({ ...decorVisablet, nameVisablet: true });
            setLoading(false);
        } else if (decor.phone === "") {
            setDecorVisablet({ ...decorVisablet, phoneVisablet: true });
            setLoading(false);
        }
    };
                        ...
                        <div className="decor_block">
                            ...
                            <div>
                                ...
                                <div className="input_box">
                                    ...
                                    <input value={decor.phone} onChange={(e) => setDecor({ ...decor, phone: e.target.value })} type="number" placeholder='' />
